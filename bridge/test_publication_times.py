...
class TimeStoreTests(unittest.TestCase):
    ...
    def test_thread_sort_honors_date_rules_and_global_mode_can_interleave(self):
        rows = [
        ...
        self.assertEqual(["thread-a", "reply-a", "thread-b", "reply-b"], [r["comment_id"] for r in grouped["rows"]])
